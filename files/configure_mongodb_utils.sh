...
curl -OL https://raw.githubusercontent.com/tosin2013/quarkus-robot-demo-role/dev/files/sample_mongo_data.json \
  && mkdir -p /data/  \
  && mv sample_mongo_data.json /data/

curl -OL https://raw.githubusercontent.com/tosin2013/quarkus-robot-demo-role/dev/files/load_database.sh \
  && chmod +x load_database.sh && mv load_database.sh /bin/load_database

curl -OL   https://raw.githubusercontent.com/tosin2013/quarkus-robot-demo-role/dev/files/configure_mongodb_user.sh \
